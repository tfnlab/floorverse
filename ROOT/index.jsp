...
<body>
  <div class="container mt-5">
    ...
    <%
        ...
        So, my dear friends, whether you're a seasoned veteran of the meme game or a fresh-faced newcomer, take heed of this number. It's not just a number - it's a statement, a challenge, a call to arms. Will you be the one to create the <%=files.length +1%>th meme? The <%=files.length +2%>th? The 1,000th?
